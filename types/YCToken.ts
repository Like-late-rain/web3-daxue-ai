...
export interface YCTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "EXCHANGE_RATE"
      | "INITIAL_SUPPLY"
...
export interface YCToken extends BaseContract {
  connect(runner?: ContractRunner | null): YCToken;
  waitForDeployment(): Promise<this>;

  interface: YCTokenInterface;
  ...
  getETHAmount: TypedContractMethod<
    [tokenAmount: BigNumberish],
    [bigint],
    "view"
  >;
